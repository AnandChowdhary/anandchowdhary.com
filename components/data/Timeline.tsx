          ...
          {visible.map((item, index) => (
            <div key={item.title}>
              {(index === 0 ||
                ...
                !hideYearHeading && (
                  <div
                    className={`flex flex-grow -ml-12 ${
                      index > 0 ? "pt-6" : ""
                    }`}
                  >
          ...
          {hasMoreHref && (
            <div className="flex pt-4 -ml-12">
              <a
                ...
                className="relative no-underline hover:shadow-md flex items-center py-2 pr-4 text-sm bg-white rounded rounded-full shadow opacity-100"
              >

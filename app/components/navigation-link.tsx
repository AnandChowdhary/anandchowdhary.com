...
export function NavigationLink({ href, label, direction }: NavigationLinkProps) {
  ...
  return (
    ...
    >
      {isPrevious && <IconChevronLeft strokeWidth={1.5} className="h-4 shrink-0" />}
      <div
      ...
      {!isPrevious && <IconChevronRight strokeWidth={1.5} className="h-4 shrink-0" />}
    </Link>
  );
}
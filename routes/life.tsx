  ...
  return (
    <>
      ...
      <div class="max-w-screen-md px-4 mx-auto space-y-12 md:px-0">
        ...
        >
          <p>
            All data is also available as a publicly-available JSON API and
            under permissive licenses on GitHub. In the (near?) future, I will
            write a blog post on how I set this up.
          </p>
        </SectionTitle>
        <section class="grid md:grid-cols-2 gap-16">
                  ...
                  return (
                    ...
                    >
                      <div class="min-w-12 relative">
                        ...
                        <div class="absolute right-0 bottom-0 left-0 top-0 flex items-center justify-center">
                          <img
                            alt=""
                            src={getFlagUrl(
                              Object(location.data?.country)?.code
                            )}
                            class="rounded-sm w-5"
                          />
                        </div>
                      ...
                      <div class="flex items-center justify-between flex-grow h-12 px-4">
                        <div>
                          {countryName(Object(location.data?.country)?.name)}
                        </div>
                        <div
          ...
          <article class="space-y-4">
            <header class="space-y-2">
              ...
              <p class="text-gray-500">
                Last week in Spotify listening history
              </p>
            </header>
            <div class="space-y-2">
              {music ? (
